            ...
            <div className="flex flex-col items-center animate-in zoom-in-95 duration-300">
              ...
              <div className="flex space-x-2 w-full">
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 bg-gray-800 hover:bg-gray-700 text-white font-medium px-2 py-3 rounded-xl transition-colors flex items-center justify-center space-x-2 border border-gray-700 text-sm shadow-sm"
                >
                ...
                <button 
                  onClick={() => {
                    navigator.clipboard.writeText(stellarUri);
                    setCopied(true);
                    setTimeout(() => setCopied(false), 2000);
                  }}
                  className="flex-1 bg-gray-800 hover:bg-gray-700 text-gray-200 font-medium px-2 py-3 rounded-xl transition-colors border border-gray-700 text-sm flex items-center justify-center space-x-2 shadow-sm"
                >
                  {copied ? (
                ...
                <button 
                  ...
                  className="flex-1 bg-gray-950 hover:bg-gray-800 text-gray-400 font-medium px-2 py-3 rounded-xl transition-colors border border-gray-800 text-sm shadow-sm"
                >
                  Close
                </button>
              </div>
